import 'package:afasia/Screens/Activities/ReconocimientoAuditivo/ElementosAisladosObjetos/components/progress_bar.dart';
...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    QuestionControllerEEO _questionController = Get.put(QuestionControllerEEO(
      context: context,
      id: id,
