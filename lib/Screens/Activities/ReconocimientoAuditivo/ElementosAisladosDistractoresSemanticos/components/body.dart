import 'package:afasia/Screens/Activities/ReconocimientoAuditivo/ElementosAisladosDistractoresSemanticos/components/progress_bar.dart';
import 'package:afasia/Screens/Activities/ReconocimientoAuditivo/ElementosAisladosDistractoresSemanticos/controllers/question_controller.dart';
...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    QuestionControllerDS _questionController = Get.put(new QuestionControllerDS(
      context: context,
      id: id,
      actividadesAsignadas: actividadesAsignadas,
    ));

    // QuestionControllerDS
