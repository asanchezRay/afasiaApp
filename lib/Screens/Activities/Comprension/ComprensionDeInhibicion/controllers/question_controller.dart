...
class QuestionControllerCDI extends GetxController
    with SingleGetTickerProviderMixin {
  QuestionControllerCDI({
    this.context,
    this.id,
  ...
  void addActividadBD(Question question, int isCorrect) async {
    ...
    ComprensionInhibicion actividad = ComprensionInhibicion(
        ...
        isCorrect,
        0);
    await db.insertarActividadComprensionInhibicion(actividad);
    await db.getAllComprensionInhibicion();
  }
}
