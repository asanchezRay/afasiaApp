// import 'package:afasia/database/models/questions.dart';
...
class QuestionControllerFO extends GetxController
    with SingleGetTickerProviderMixin {
  QuestionControllerFO({
    this.context,
    this.id,
  ...
  void _setQuestion() {
    ...
    print(this._questions[0].question);
  }
