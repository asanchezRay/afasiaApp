...
import 'package:afasia/Screens/Activities/Lectura/NominacionObjetos/models/questions.dart';
...
class _QuestionCardState extends State<QuestionCard> {
  ...
  Widget build(BuildContext context) {
    QuestionControllerNO _controller = Get.put(QuestionControllerNO());
    if (_stringCreated) {
                ...
                children: [
                  RawMaterialButton(
                    onPressed: () async {
                      ...
                      await db.insertarActividadNominacionObjetos(actividad);
