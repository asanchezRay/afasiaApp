...
class QuestionControllerLOS extends GetxController
    with SingleGetTickerProviderMixin {
  QuestionControllerLOS({
    this.context,
    this.id,
  ...
  void onInit() {
    ...
    for (int i = 0; i < 5; i++) {
      print(this._questions[i].question);
    }

    _animationController =
        AnimationController(duration: Duration(days: 365), vsync: this);
