...
import 'package:afasia/Screens/Activities/Lectura/LecturaOracionesSimples/models/questions.dart';
...
class _QuestionCardState extends State<QuestionCard> {
  ...
  Widget build(BuildContext context) {
    QuestionControllerLOS _controller = Get.put(QuestionControllerLOS());
    if (_stringCreated) {
                ...
                children: [
                  ...
                  RawMaterialButton(
                    onPressed: () async {
                      ...
                      await db.initDB();
                      var actividad = LecturaOraciones(rutPacienteTrabajando, 0,
