import 'package:afasia/Screens/Activities/Lectura/LecturaOracionesSimples/components/progress_bar.dart';
...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    ...
    QuestionControllerLOS _questionController = Get.put(QuestionControllerLOS(
      context: context,
      id: id,
