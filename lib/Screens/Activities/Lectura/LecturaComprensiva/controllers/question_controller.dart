...
class QuestionControllerLC extends GetxController
    with SingleGetTickerProviderMixin {
  QuestionControllerLC({
    this.context,
    this.id,
  ...
  void addActividadBD(Question question, int isCorrect) async {
    ...
    LecturaComprensiva actividad = LecturaComprensiva(
        ...
        isCorrect,
        0);
    await db.insertarActividadLecturaComprensiva(actividad);
  }
}
