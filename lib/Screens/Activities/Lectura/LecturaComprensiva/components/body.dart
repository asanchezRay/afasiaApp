import 'package:afasia/Screens/Activities/Lectura/LecturaComprensiva/components/progress_bar.dart';
...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    QuestionControllerLC _questionController = Get.put(QuestionControllerLC(
      context: context,
      id: id,
