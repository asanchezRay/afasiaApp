import 'package:afasia/Screens/Activities/Lectura/LecturaPalabras/components/progress_bar.dart';
...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    QuestionControllerLP _questionController = Get.put(QuestionControllerLP(
      context: context,
      id: id,
