...
import 'package:afasia/Screens/Activities/Lectura/LecturaPalabras/controllers/question_controller.dart';
...
class _QuestionCardState extends State<QuestionCard> {
  ...
  Widget build(BuildContext context) {
    QuestionControllerLP _controller = Get.put(QuestionControllerLP());
    if (_stringCreated) {
                ...
                children: [
                  ...
                  RawMaterialButton(
                    onPressed: () async {
                      ...
                      await db.initDB();
                      var actividad = LecturaOraciones(rutPacienteTrabajando, 1,
                          widget.question.question, filename, 0);
                      await db.insertarActividadLecturaOraciones(actividad);
                      await db.getAllLecturaOraciones();
                      print(rutPacienteTrabajando);
                      if (!_isDisabledPlayButton) {
