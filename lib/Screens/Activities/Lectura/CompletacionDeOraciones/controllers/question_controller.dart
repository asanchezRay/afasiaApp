...
import 'package:afasia/Screens/Activities/Lectura/CompletacionDeOraciones/models/questions.dart';
...
class QuestionControllerCDO extends GetxController
    with SingleGetTickerProviderMixin {
  QuestionControllerCDO({
    this.context,
    this.id,
  ...
  void addActividadBD(Question question, int isCorrect) async {
    ...
    CompletacionOraciones actividad = CompletacionOraciones(
        ...
        isCorrect,
        0);
    await db.insertarActividadCompletacionDeOraciones(actividad);
    await db.getAllCompletacionOraciones();
  }
}
