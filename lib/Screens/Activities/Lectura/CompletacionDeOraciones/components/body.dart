import 'package:afasia/Screens/Activities/Lectura/CompletacionDeOraciones/components/progress_bar.dart';
import 'package:afasia/Screens/Activities/Lectura/CompletacionDeOraciones/controllers/question_controller.dart';
...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    QuestionControllerCDO _questionController = Get.put(QuestionControllerCDO(
      context: context,
      id: id,
