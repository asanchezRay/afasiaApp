import 'package:afasia/Screens/Activities/Lectura/NominacionAcciones/components/progress_bar.dart';
...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    QuestionControllerNA _questionController = Get.put(QuestionControllerNA(
      context: context,
      id: id,
