...
import 'package:afasia/Screens/Activities/Escritura/CopiaDeLetras/components/progress_bar.dart';
import 'package:afasia/Screens/Activities/Escritura/CopiaDeLetras/components/question_card.dart';
...
class CopiaLetrasScreen extends StatefulWidget {
  final List<int> actividadesAsignadas;

  const CopiaLetrasScreen({Key key, @required this.actividadesAsignadas})
      : super(key: key);
  @override
  _CopiaLetrasScreenState createState() =>
      _CopiaLetrasScreenState(actividadesAsignadas);
}

class _CopiaLetrasScreenState extends State<CopiaLetrasScreen> {
  ...
  _CopiaLetrasScreenState(this.actividadesAsignadas);
  ...
  void initState() {
    ...
    assetsAudioPlayer.open(
      Audio("assets/audio/copieLetraInstruccion.mp3"),
    );
  ...
  Widget build(BuildContext context) {
    ...
    QuestionControllerCL _questionController = Get.put(QuestionControllerCL(
  ...
  Widget _showBody(QuestionControllerCL _questionController) {
    final double width = MediaQuery.of(context).size.width;
    return Stack(
      children: <Widget>[
        Container(
