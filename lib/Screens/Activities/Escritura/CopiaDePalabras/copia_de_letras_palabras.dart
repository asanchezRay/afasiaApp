...
import 'package:afasia/Screens/Activities/Escritura/CopiaDePalabras/components/progress_bar.dart';
import 'package:afasia/Screens/Activities/Escritura/CopiaDePalabras/components/question_card.dart';
import 'package:afasia/Screens/Activities/Escritura/CopiaDePalabras/controllers/question_controller.dart';
...
class CopiaPalabrasScreen extends StatefulWidget {
  final List<int> actividadesAsignadas;

  const CopiaPalabrasScreen({Key key, @required this.actividadesAsignadas})
      : super(key: key);
  @override
  _CopiaPalabrasScreenState createState() =>
      _CopiaPalabrasScreenState(actividadesAsignadas);
}

class _CopiaPalabrasScreenState extends State<CopiaPalabrasScreen> {
  ...
  _CopiaPalabrasScreenState(this.actividadesAsignadas);
  ...
  void initState() {
    ...
    assetsAudioPlayer.open(
      Audio("assets/audio/copiaPalabraInstruccion.mp3"),
    );
  ...
  Widget build(BuildContext context) {
    ...
    QuestionControllerCP _questionController = Get.put(QuestionControllerCP(
      context: context,
      id: id,
  ...
  Widget _showBody(QuestionControllerCP _questionController) {
    final double width = MediaQuery.of(context).size.width;
    return Stack(
      children: <Widget>[
        Container(
