...
import 'package:afasia/Screens/Activities/Escritura/EscrituraDescriptiva/models/questions.dart';
...
class QuestionControllerED extends GetxController
    with SingleGetTickerProviderMixin {
  QuestionControllerED(
      {this.context,
      this.id,
